...
public class Slider: UIView {
    ...
    */
    ...
    var context: UIViewRepresentableContext<SliderView>!
    
    init(frame: CGRect, context: UIViewRepresentableContext<SliderView>) {
...
//        let bundle = Bundle(path: Bundle(for: type(of: self)).path(forResource: "TVKit", ofType: "bundle")!)
        let nib = UINib(nibName: "Slider", bundle: nil)
