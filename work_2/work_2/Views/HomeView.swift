    ...
    var body: some View {
        VStack{
          TitleView( title: "Home view")
            ...
            List(countryViewModel.countries) { item in
                VStack(alignment: .leading) {
                    ...
                    .onTapGesture {
                        self.navigation.push(NavigationItem(view: AnyView(WeatherView().environmentObject(WeatherViewModel(countryData: item)))))
                    }
                }
            }
